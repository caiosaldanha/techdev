...
function Pessoa(nomeCompleto, sexo, cpf, nascimento, renda, hobbies) {
  ...
  this.verificarTipoConta = function () {
    if (this.renda >= 5000.0) {
      return (
        "O cliente " +
        this.nomeCompleto +
        ", cuja renda é " +
        this.renda +
        ", terá uma conta especial"
      );
    } else {
      return (
        "O cliente " +
...
//new
let pessoa = new Pessoa("Chris", "m", "001.111.222-33", "21/09/80", 20000, [
  "Ler",
  "Nadar",
  "Anime",
]);
let pessoa1 = new Pessoa("Maria", "f", "991.111.222-33", "30/09/80", 20000, [
  "Correr",
  "Ler",
]);
